...
public class PdfTest extends Application {
    ...
    public void start(Stage stage) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(PdfTest.class.getResource("PdfTest.fxml"));
    ...
    // generatePdf("src/main/resources/com/example/financingtool/tree.jpg", "src/main/resources/com/example/financingtool/Ausgabedokument.pdf");


    public static void generatePdf(String imagePath) {
        try {
            // Pfad zur vorhandenen PDF-Datei
            String existingPdfPath = "src/main/resources/com/example/financingtool/SEPJ-Rechnungen.pdf";

            // Pfad zur Ausgabedatei
            String outputPdfPath = "src/main/resources/com/example/financingtool/SEPJ-Rechnungen.pdf";
